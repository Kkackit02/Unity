...
void Terminate()
{
    printf("Terminate!\n");
#ifdef UNIT_TEST
    outputSetVal.outputArray[outputSetVal.outputArrayCnt] = 1;
    outputSetVal.outputArrayCnt++;
#endif
}
void GoForwardAndCleanerOn()
{
    ...
    printf("Cleaner ON\n");
#ifdef UNIT_TEST
    outputSetVal.outputArray[outputSetVal.outputArrayCnt] = 2;
    outputSetVal.outputArrayCnt++;
#endif
}
...
#ifdef UNIT_TEST
    outputSetVal.outputArray[outputSetVal.outputArrayCnt] = 3;
    outputSetVal.outputArrayCnt++;
#endif
}
void TurnLeft()
...
#ifdef UNIT_TEST
    outputSetVal.outputArray[outputSetVal.outputArrayCnt] = 4;
    outputSetVal.outputArrayCnt++;
#endif
}
void TurnRight()
...
#ifdef UNIT_TEST
    outputSetVal.outputArray[outputSetVal.outputArrayCnt] = 5;
    outputSetVal.outputArrayCnt++;
#endif
}
void TurnBackward()
...
#ifdef UNIT_TEST
    outputSetVal.outputArray[outputSetVal.outputArrayCnt] = 6;
    outputSetVal.outputArrayCnt++;
#endif
}
